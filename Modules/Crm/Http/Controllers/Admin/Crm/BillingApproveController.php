...
class BillingApproveController extends Controller
{

    /**
     * String property
     */
    protected $routeName =  'billing_approv';
    protected $viewName =  'crm::admin.pages.crm.billing_approv';
    ...
    public function dataProcessing()
    {
        return $this->getDataResponse(
            //Model Instance
            $this->getModel()->where('billing_approve' , "0")->where('sales_approve',"1")->where('reject_sales_approve',"0"),
            //Table Columns Name
            $this->tableColumnNames(),
            //Route name
            $this->routeName,
    ...
    public function approve(Request $request, $id) {
        ...
        $billingApprove->billing_approve_by = Auth::user()->id;
        $billingApprove->business_id = $request->input('businessId');
        $billingApprove->save();
        setNotification('tx_planning',"New Client Tx Planning Approve Notification",route('noc_approv.index'));
        ...
        return response()->json(['code' => 200, 'message' => 'Lead approved successfully', 'redirect_url' => route('billing_approv.index')]);
    }
}
