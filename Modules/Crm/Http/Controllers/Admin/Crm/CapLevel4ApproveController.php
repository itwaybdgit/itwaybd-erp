...
class CapLevel4ApproveController extends Controller
{

    /**
     * String property
     */
    protected $routeName =  'cap_level4_approv';
    protected $viewName =  'crm::admin.pages.crm.cap_noc2_approv';
    ...
    public function store(Request $request, $id) {
        ...
        return redirect()->route('cap_level4_approv.index')->with('success', 'Remarks added successfully!');
    }

    public function approve($id) {
        $noc2Approve = ResellerCapUncap::findOrFail($id);
        $noc2Approve->level4_approve = '3';
        $noc2Approve->level3_approve = "3";
        $noc2Approve->save();
        // return redirect()->route('admin_approv.index')->with('success', 'Lead approved successfully!');
        return response()->json(['code' => 200, 'message' => 'Level 4 approved successfully', 'redirect_url' => route('cap_level4_approv.index')]);
    }
}
