...
class ConfirmBillingApproveController extends Controller
{
    /**
     * String property
     */
    protected $routeName =  'confirm_billing_approv';
    protected $viewName =  'crm::admin.pages.crm.confirm_billing_approv';
    ...
    public function dataProcessing()
    {
        return $this->getDataResponse(
            //Model Instance
            $this->getModel()->where('level_confirm','1'),
            //Table Columns Name
            $this->tableColumnNames(),
            //Route name
            $this->routeName,
    ...
    // dd($bandwidthsaleinvoice);
      ...
      return redirect()->route('confirm_billing_approv.index')->with('success', 'Bill Generate successfully!');
    }
}
