...
class LeadGenerationController extends Controller
{
    ...
    protected $viewName =  'crm::admin.pages.crm.lead';
...
//        return $request;
    ...
    function schedule(LeadGeneration $lead) {
        ...
        return view('crm::admin.pages.crm.lead.schedule',get_defined_vars());
    }
    ...
    public function edit(LeadGeneration $lead)
    {
        ...
        $editinfo = $lead;
        $company = auth()->user()->company;
        $comloc = CompanyLocation::where('company_id', $company->id)->where('branch_id', $lead->branch_id)->first();
