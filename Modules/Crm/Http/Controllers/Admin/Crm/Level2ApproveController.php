...
class Level2ApproveController extends Controller
{
    /**
     * String property
     */
    protected $routeName =  'level_2';
    protected $viewName =  'crm::admin.pages.crm.level_2';
    ...
    public function dataProcessing()
    {
        return $this->getDataResponse(
            //Model Instance
            $this->getModel()->where('assign_to' , "2")->whereNull('level_confirm'),
            //Table Columns Name
            $this->tableColumnNames(),
            //Route name
            $this->routeName,
