...
class NIRequestTransmissionController extends Controller
{
    ...
    protected $routeName =  'nirequest_transmission';
    protected $viewName =  'crm::admin.pages.crm.nirequest_transmission';
