                        ...
                        <form action="{{ $update_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row text-center">
                                <div class="col-md-12 mb-3">
                                        <h2 class="text-center mb-2">Message Time Schedule</h2>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Follow-up Schedule</label>
                                    <input type="text" class="form-control" value=" {{ $editinfo->follow_up_message_time }}" name="follow_up_message_time">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Meeting Schedule</label>
                                    <input type="text" class="form-control" value=" {{ $editinfo->meeting_message_time }}" name="meeting_message_time">
                                </div>
                            </div>
                            <div class="row text-center">
                                <div class="col-md-12 mb-3">
