                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 ms-4 mb-3">
                                            <label for="division_default_value" class="form-label">Branch:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="division" name="fields[]" value="division"
                                                {{ in_array('division', json_decode($editinfo->fields) ?? ['jj']) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="division">
                                                <strong>Division</strong>
                                            </label>
                                        </div>
                                        <div id="division_default" class="col-md-4 ms-4 mb-3" style="display: {{ in_array('division', json_decode($editinfo->fields) ?? []) ? 'block' : 'none' }};">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="district" name="fields[]" value="district"
                                                {{ in_array('district', json_decode($editinfo->fields) ?? ['jj']) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="district">
                                                <strong>District</strong>
                                            </label>
                                        </div>
                                        <div id="district_default" class="col-md-4 ms-4 mb-3" style="display: {{ in_array('district', json_decode($editinfo->fields) ?? []) ? 'block' : 'none' }};">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="upazila" name="fields[]" value="upazila"
                                                {{ in_array('upazila', json_decode($editinfo->fields) ?? ['jj']) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="upazila">
                                                <strong>Upazila</strong>
                                            </label>
                                        </div>
                                        <div id="upazila_default" class="col-md-4 ms-4 mb-3" style="display: {{ in_array('upazila', json_decode($editinfo->fields) ?? []) ? 'block' : 'none' }};">
                                    ...
                                    <div class="row">
{{--                                        <div class="col-md-2 form-check mb-3">--}}
{{--                                            <input class="form-check-input" type="checkbox" id="address" name="fields[]" value="address"--}}
{{--                                                {{ in_array('address', json_decode($editinfo->fields) ?? ['jj']) ? 'checked' : '' }}>--}}
{{--                                            <label class="form-check-label" for="address">--}}
{{--                                                <strong>Address</strong>--}}
{{--                                            </label>--}}
{{--                                        </div>--}}
{{--                                        <div id="address_default" class="col-md-4 ms-4 mb-3" style="display: {{ in_array('address', json_decode($editinfo->fields) ?? []) ? 'block' : 'none' }};">--}}
