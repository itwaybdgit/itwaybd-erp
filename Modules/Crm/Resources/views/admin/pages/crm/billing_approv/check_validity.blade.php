                        ...
                        <div class="container">
                            ...
                            <form action="{{ route('reverts.store', $customer->id) }}" method="POST">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <button type="button" class="btn btn-primary confirm" approve-route="{{ route('billing_approv.approve', $customer->id) }}" >{{ __('Confirm') }}</button>
                                </div>
                            </form>
                        </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        {{-- <div class="card mt-5">
                          ...
                          @foreach ($packages as $package)
                            ...
                            <p>{{ $package->rate }}</p>
                            <p>{{ $package->vat }}</p>
                            <p>Sub-Total : {{ $subTotal = $package->qty * $package->rate + (($package->qty * $package->rate) * $package->vat/100) }}</p>
                            <p>Total : {{ $subTotal }}</p>
                            @php
                              $total += $subTotal;
                            @endphp
