                            ...
                            <div class="card-body">
                              ...
                              <hr>
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <button type="button" class="btn btn-primary confirm" approve-route="{{ route('cap_level4_approv.approve', $customer->id) }}" >{{ __('Confirm') }}</button>
                                    </div>
                            </div>
                          </div>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <h5>Uncap Package</h5> <p>Duration: {{$customer->apply_date}}</p>
