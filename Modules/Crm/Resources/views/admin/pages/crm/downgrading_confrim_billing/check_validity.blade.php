            ...
            <div class="main-body">
                <div class="row gutters-sm">
                    ...
                    <div class="col-md-12 mb-1">
                        <form action="{{ route('downgrading-confrim-billing.confirm', $customer->id) }}" method="post">
                            @csrf
                            {{-- <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <input type="date" value="{{\Carbon\Carbon::now()->startOfMonth()->format('Y-m-d')}}" name="from_date[]"
                                            class="form-control from_date calculation">
                                    </th>
                                    <th>
                                        <input type="date" value="{{ Carbon\Carbon::now()->lastOfMonth()->format('Y-m-d')}}" name="to_date[]"
                            ...
                            <tfoot>
                                <tr style="background-color: rgb(194, 194, 194);">
                                    ...
                                    <td ><input type="text" value="0" id="GrandTotal"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3 mb-3">
                                        <div class="col-6">
                                            ...
                                            <input type="hidden" name="reseller_upgradation"
                                                value="{{ $resellerUpgradation->id }}">
                                            <input type="date" name="apply_date" class="form-control"
                                                value="{{ $resellerUpgradation->apply_date }}" id="apply_date">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('scripts')
    <script>
        document.getElementById("apply_date").min = new Date().getFullYear() + "-" + parseInt(new Date().getMonth() + 1) +
            "-" + new Date().getDate()
