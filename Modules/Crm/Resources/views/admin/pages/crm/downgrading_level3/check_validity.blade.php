        ...
        <div class="container">
            <div class="main-body">
                <div class="row gutters-sm">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <div class="col-md-12">
                                    <a href="{{ route('downgrading-level3.confirm', $customer->id) }}"
                    ...
                    <form action="{{ route('downgrading-level3.updatestore', $customer->id) }}" method="post">
                        @csrf
                                            ...
                                            @foreach ($vlan as $key => $val)
                                                @if ($val)
                                                    <tr>
                                                        ...
                                                        <td><input type="text" value="{{ $vlan[$key] ?? 0 }}"
                                                                name="vlan[]" class="form-control" autocomplete="off"></td>
                                                        <td><input type="text" value="{{ $ip[$key] ?? 0 }}"
                                                                name="ip[]" class="form-control" autocomplete="off"></td>
                                    ...
                                    <tr>
                                        <td>
                                            <select class="form-control" id="item_id_ext">
                                                @foreach ($customer->package as $value)
                                                    <option value="{{ $value->item_id }}">{{ $value->item->name ?? '' }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </td>
                                            ...
                                            @if ($item)
                                                <tr>
                                                    ...
                                                    <td><input type="text" value="{{ $remote_asn[$key] }}"
                                                            name="remote_asn[]" class="form-control" autocomplete="off">
                                                    </td>
                                                    <td><input type="text" value="{{ $client_asn[$key] }}"
                                                            name="client_asn[]" class="form-control" autocomplete="off">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td><input type="text" value="{{ $ip_lease[$key] }}"
                                                            name="ip_lease[]" class="form-control" autocomplete="off">
                                                    </td>
                                                    <td><button type="button"
                                                            class="itemremove btn btn-danger btn-sm "><i
                                                                class="fas fa-minus"></i></button></td>
                                        ...
                                        @foreach ($pop_id as $itemkey => $item)
                                            <tr>
                                                    ...
                                                    <select name="pop_id[]" class="form-control" id="pop_id">
                                                        @foreach ($ports as $itemd)
                                                            <option {{ $item == $itemd->id ? 'selected' : '' }}
                                                                value="{{ $itemd->id }}">{{ $itemd->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                ...
                                                <td><input type="text" class="form-control"
                                                        value="{{ $device_name[$itemkey] }}" name="device_name[]"></td>

                                                <td>
                                                    <select name="port_type_id[]" class="form-control fo qrm-control"
                                                        id="port_type">
                                                        <option {{ $port_type[$itemkey] == '1g' ? 'selected' : '' }}
                                                            value="1g">1g</option>
                                                        <option {{ $port_type[$itemkey] == '10g' ? 'selected' : '' }}
                                                            value="10g">10g</option>
                                                        <option {{ $port_type[$itemkey] == '40g' ? 'selected' : '' }}
                                                            value="40g">40g</option>
                                                        <option {{ $port_type[$itemkey] == '100g' ? 'selected' : '' }}
                                                            value="100g">100g</option>
                                                        <option {{ $port_type[$itemkey] == 'etherp45' ? 'selected' : '' }}
                                                ...
                                                <td><button type="button" class="itemremove btn btn-danger btn-sm "><i
                                                            class="fas fa-minus"></i></button></td>
                                            </tr>
                                        @endforeach
                                    @endif
