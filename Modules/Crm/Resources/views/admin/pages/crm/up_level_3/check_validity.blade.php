        ...
        <div class="container">
            <div class="main-body">
                  <div class="row gutters-sm">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                              ...
                              <hr>
                              <div class="col-md-12">
                                <a href="{{route('upgradtionlist-level3.confirm',$customer->id)}}" class="btn btn-info">Done</a>
                            </div>
                            </div>
                          </div>
                    ...
                    <form action="{{ route('upgradtionlist-level3.updatestore', $customer->id) }}" method="post">
                        @csrf
