...
use Modules\Crm\Http\Controllers\Admin\Crm\AdminApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\BillingApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\BranchController;
use Modules\Crm\Http\Controllers\Admin\Crm\ConfirmBillingApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\FollowUpListController;
use Modules\Crm\Http\Controllers\Admin\Crm\LeadGenerationController;
use Modules\Crm\Http\Controllers\Admin\Crm\LegalApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\Level1ApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\Level2ApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\Level3ApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\MeetingDateController;
use Modules\Crm\Http\Controllers\Admin\Crm\Noc2ApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\NocApproveController;
use Modules\Crm\Http\Controllers\Admin\Crm\OpportunityController;
use Modules\Crm\Http\Controllers\Admin\Crm\TransmissionApproveController;
...
Route::name('company_location.')->prefix('company_location')->group(function () {
    ...
    Route::get('/delete/{companylocation:id}', [CompanyLocationController::class, 'destroy'])->name('destroy');
});
