                        ...
                        if ($columnItem['data'] == 'action' && $show_action) {
                            ...
                            foreach ($actions as $action) {
                                if (!empty($action) && !is_array($action)) {
                                    if (strtolower($action) == 'show' && has_route($routeName . '.show')) {
                                        $nestedData['action'] .= $this->showBtn(route($routeName . '.show', $item->id));
                                    } else if (strtolower($action) == 'edit' && has_route($routeName . '.edit')) {
                                        $nestedData['action'] .= $this->editBtn(route($routeName . '.edit', $item->id));
                                    } else if (strtolower($action) == 'destroy' && has_route($routeName . '.destroy')) {
