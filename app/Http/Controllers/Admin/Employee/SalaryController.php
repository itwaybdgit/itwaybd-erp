...
class SalaryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $valideted['payment_id'] = $request->payment_id;
