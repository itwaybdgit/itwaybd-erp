...
{
    protected $routeName =  'leaveApplication';
    protected $viewName =  'admin.pages.leave_application';
    ...
    {
        $page_title = "Leave Application Edit";
        $page_heading = "Leave Application Edit";
        $back_url = route($this->routeName . '.index');
        $update_url = route($this->routeName . '.update', $leave->id);
        $employees = Employee::all();
        $editinfo = $leave;
