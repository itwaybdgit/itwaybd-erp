...
class LoneApplicationApproveController extends Controller
{
    protected $routeName =  'loneApplicationApprove';
    protected $viewName =  'admin.pages.lone_application_approve';
    ...
    public function index()
    {
        ...
        $page_heading = "Loan Application List";
    ...
    {
        $page_title = "Loan Application Create";
        $page_heading = "Loan Application Create";
    ...
    public function cancel(LoneApplication $lone)
    {
        if ($lone->status == 'pending') {
            $lone->status = 'cancel';
