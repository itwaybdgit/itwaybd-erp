...
class MPPPProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.dynamicIndex', get_defined_vars());
    }
    ...
    public function dataProcessing(Request $request)
    {
        ...
        if (request('columns.6.search.value'))
            $model = $model->where('server_id', request('columns.6.search.value'));
        return $this->getDataResponse(
            //Model Instance
            $model,            //Table Columns Name
            $this->tableColumnNames(),
            //Route name
            $this->routeName
        );
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // $speed ? $query->equal("rate-limit", $speed . '/' . $speed) : null;
