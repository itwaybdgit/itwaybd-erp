...
class TeamController extends Controller
{
    ...
    protected $viewName =  'admin.pages.Team';
    ...
    public function edit(Team $team)
    {
        ...
        $page_heading = "Team Edit";
        $back_url = route($this->routeName . '.index');
        $update_url = route($this->routeName . '.update', $team->id);
        $editinfo = $team;
