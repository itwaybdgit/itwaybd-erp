...
class DiscontinueBillingController extends Controller
{

    /**
     * String property
     */
    protected $routeName =  'discontinue_billing';
    protected $viewName =  'admin.pages.crm.discontinue_billing_approv';
    ...
    public function approve($id) {
        $billingApprove = ResellerDiscontinue::findOrFail($id);
        ...
        $billingApprove->save();
        setNotification("tx_planning","New tx_planning Approve Request",route('discontinue_tx.index'));


        return response()->json(['code' => 200, 'message' => 'Billing approved successfully', 'redirect_url' => route('discontinue_billing.index')]);
    }
}
