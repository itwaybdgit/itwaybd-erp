...
class DowngradtionListLevel3Controller extends Controller
{
    /**
     * String property
     */
    protected $routeName =  'downgrading-level3';
    protected $viewName =  'admin.pages.crm.downgrading_level3';
    ...
    public function dataProcessing()
    {
        return $this->getDataResponse(
            //Model Instance
            $this->getModel()->where('noc2_approve' , '3'),
            //Table Columns Name
            $this->tableColumnNames(),
            //Route name
            $this->routeName,
    ...
    public function assing_by(Request $request,BandwidthCustomer $customer) {
        ...
        return redirect()->route('downgrading-level3.index')->with('success', 'Assign successfully!');
    }
    ...
    public function confirm(BandwidthCustomer $customer) {
        ...
        setNotification("billing_department","New Confirm Billing Approve Request",route('downgrading-confrim-billing.index'));
