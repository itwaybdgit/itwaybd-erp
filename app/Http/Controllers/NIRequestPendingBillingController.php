...
class NIRequestPendingBillingController extends Controller
{
    /**
     * String property
     */

    protected $routeName =  'nirequest_pending_billing';
    protected $viewName =  'admin.pages.crm.nirequest_pending_billing';
