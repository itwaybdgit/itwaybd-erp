...
class NIRequestSaleHeadController extends Controller
{
    /**
     * String property
     */
    protected $routeName =  'nirequest_salehead';
    protected $viewName =  'admin.pages.crm.nirequest_salehead';
...
//         dd($bcp);
    ...
    public function approve($id) {
        $salesApprove = ResellerNIRequest::findOrFail($id);
