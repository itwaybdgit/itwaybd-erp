...
class OptimizeBillingController extends Controller
{

    /**
     * String property
     */
    protected $routeName =  'optimize_billing';
    protected $viewName =  'admin.pages.crm.optimize_billing_approv';
    ...
    public function approve($id) {
        $billingApprove = ResellerOptimize::findOrFail($id);
        ...
        $billingApprove->save();
        setNotification('tx_planning',"New BIlling Aprrove Request",route('optimize_tx.index'));
