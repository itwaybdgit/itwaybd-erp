...
class OptimizeSaleHeadController extends Controller
{
    /**
     * String property
     */
    protected $routeName =  'optimize_salehead';
    protected $viewName =  'admin.pages.crm.optimize_salehead';
    ...
    public function approve($id) {
        $salesApprove = ResellerOptimize::findOrFail($id);
        $salesApprove->sale_head_approve = '2';
        $salesApprove->bill_head_approve = '1';
        $salesApprove->sale_head_by = Auth::user()->id;
        $salesApprove->save();
        setNotification('billing_department',"New Confrim billing Approve Request",route("optimize_billing.index"));
