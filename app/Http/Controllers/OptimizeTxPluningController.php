...
class OptimizeTxPluningController extends Controller
{
    /**
     * String property
     */
    ...
    protected $viewName =  'admin.pages.crm.optimize_tx';
    ...
    public function approve($id) {
        ...
        $nocApprove->save();
        setNotification("transmission","New transmission Aprrove Request",route('optimize_transmission.index'));
