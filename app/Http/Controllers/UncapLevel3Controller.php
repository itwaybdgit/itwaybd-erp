...
class UncapLevel3Controller extends Controller
{
    /**
     * String property
     */
    protected $routeName =  'upcap_level3';
    protected $viewName =  'admin.pages.crm.uncap_level_3';
    ...
    public function dataProcessing()
    {
        return $this->getDataResponse(
            //Model Instance
            $this->getModel()->where('level3_approve' , '1'),
            //Table Columns Name
            $this->tableColumnNames(),
            //Route name
            $this->routeName,
    ...
    //         $invoiceDetail->save();
    //     }
        return redirect()->route('upcap_level3.index')->with('success', 'Assign successfully!');
    }
