...
class UpgradtionListtxpluningController extends Controller
{
    /**
     * String property
     */

    protected $routeName =  'upgradtionlist_tx';
    protected $viewName =  'admin.pages.crm.upgradtionlist_tx';
    ...
    public function dataProcessing()
    {
        return $this->getDataResponse(
            //Model Instance
            $this->getModel()->where('noc_approve' , 2),
            //Table Columns Name
            $this->tableColumnNames(),
            //Route name
            $this->routeName,
    ...
    public function approve($id) {
        ...
        $nocApprove->noc2_approve = '2';
        $nocApprove->save();
        setNotification("level_3","New level_3 Approve Request",route('upgradtionlist-level3.index'));

        return response()->json(['code' => 200, 'message' => 'Lead approved successfully', 'redirect_url' => route('upgradtionlist_tx.index')]);
    }
}
