...
class CreateResellerNirequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reseller_nirequests', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('reseller_nirequests');
    }
}
