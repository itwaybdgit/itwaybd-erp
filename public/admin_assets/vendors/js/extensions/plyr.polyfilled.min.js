"object" == typeof navigator &&
    (function (e, t) {
        ...
        var J,
            ...
            ee = t(function (e) {
                ...
                (e.exports = function (e, t, a, o) {
                    ...
                    return (
                        ("function" == typeof this && t(this).source) || _(this)
                    );
                });
            }),
            te = i,
        ...
        if (
            (Le ||
                (ee(
                    (gt = function () {
                        ...
                        return (
                            a && Ct && Ot(mt, t, { configurable: !0, set: n }),
                            It(t, e)
                        );
                    }).prototype,
                    "toString",
            ...
            Ie(
                { global: !0, wrap: !0, forced: !Le, sham: !Le },
                { Symbol: gt }
            ),
            ut(Me(Pt), function (e) {
                Ze(e);
        ...
        Oi("search", 1, function (e, t, n) {
            return [
                ...
                function (e) {
                    ...
                    var s = ji(r, a);
                    return (
                        Di(r.lastIndex, o) || (r.lastIndex = o),
                        null === s ? -1 : s.index
                    );
                },
            ];
        ...
        var Fi = Xe("match"),
            qi = function (e) {
                var t;
                return (
                    g(e) && (void 0 !== (t = e[Fi]) ? !!t : "RegExp" == h(e))
                );
            },
            Hi = Xe("species"),
            Bi = function (e, t) {
            ...
            mr = function (e) {
                ...
                if (
                    ...
                    for (
                        ...
                        (o = h ? cr(r, u, [i.value, d], !0) : i.value),
                            Fn(n, d, o);
                return (n.length = d), n;
            },
            gr = /[^\0-\u007E]/,
        ...
        var Ls = {
            ...
            js =
                (t(function (e) {
                            ...
                            if (
                                ...
                                v ||
                                    (((u = t(function (t, n) {
                                        ...
                                        var i = Xo(new l(), t, u);
                                        return (
                                            null != n && ks(n, i[s], i, a), i
                                        );
                                    })).prototype = c),
                                    (c.constructor = u)),
                                    (m || y) &&
                                        (f("delete"), f("has"), a && f("get")),
                                    (y || p) && f(s),
                    ...
                    if (D && a) {
                        (t = Ls.getConstructor(s, "WeakMap", !0)),
                            (ws.REQUIRED = !0);
                        var c = l.prototype,
                            u = c.delete,
                            h = c.has,
        ...
        var zs = l.f,
            Ws = function (e) {
                return function (t) {
                    for (
                        var n, i = m(t), r = Me(i), o = r.length, s = 0, l = [];
                        o > s;
                ...
                return [
                    ...
                    function (e) {
                        ...
                        for (var s, l = [], c = 0; null !== (s = ji(r, a)); ) {
                            ...
                            (l[c] = u),
                                "" === u &&
                                    (r.lastIndex = Li(a, le(r.lastIndex), o)),
                                c++;
                        }
                        return 0 === c ? null : l;
                    },
            ...
            "process" == h(Cl)
                ...
                ? (vl =
                      "onreadystatechange" in T("script")
                          ? function (e) {
                                Ue.appendChild(T("script")).onreadystatechange =
                                    function () {
        ...
        var Du,
            ...
            qu = {
                ...
                check: function (e, t, n) {
                    ...
                    return {
                        ...
                        ui:
                            r &&
                            qu.rangeInput &&
                            ("video" !== e || !gu.isIPhone || i),
                    };
                },
                pip: !(
                    gu.isIPhone ||
                    (!ru(Au("video").webkitSetActiveationMode) &&
                ...
                mime: function (e) {
                    ...
                    Object.keys(Fu).includes(n) &&
                        (n += '; codecs="'.concat(Fu[e], '"'));
                    try {
                        return Boolean(
                ...
                Hu && (l = { passive: a, capture: o }),
                    s.forEach(function (t) {
                        i &&
                            ...
                            e[r ? "addEventListener" : "removeEventListener"](
                                t,
                                n,
                                l
                            );
        ...
        var jh = {
                ...
                return (
                    a.toggle
                        ? (o.appendChild(
                          ...
                          o.appendChild(
                              jh.createIcon.call(this, a.icon, {
            ...
            bindMenuItemShortcuts: function (e, t) {
                ...
                Vu.call(
                    ...
                    Vu.call(this, e, "keyup", function (e) {
                        13 === e.which &&
                            jh.focusFirstMenuItem.call(n, null, !0);
                    });
            },
            ...
            timeUpdate: function (e) {
                var t =
                    !su(this.elements.display.duration) &&
            ...
            updateSetting: function (e, t, n) {
                ...
                if (
                    (su(a) || (a = i && i.querySelector('[role="menu"]')),
                    su(a))
                ) {
            ...
            showMenuPanel: function () {
                ...
                if (su(i)) {
                    ...
                    Lu(a, !0),
                        Lu(i, !1),
                        jh.focusFirstMenuItem.call(this, i, n);
                }
            },
            ...
            create: function (e) {
                ...
                return (
                    th(
                        au(this.config.controls) ? this.config.controls : []
                    ).forEach(function (s) {
                        if (
                            ("restart" === s &&
                    ...
                    this.isHTML5 &&
                        s.call(this, eh.getQualityOptions.call(this)),
                    l.call(this),
                    u
                );
            },
                ...
                update: function () {
                    ...
                    this.isHTML5 &&
                        ...
                        ((s && this.language !== r) || !t.includes(o)) &&
                            (Mh.setLanguage.call(this, r),
                            Mh.toggle.call(this, i && s)),
                        ju(
                            this.elements.container,
                        ...
                        if (su(this.elements.captions))
                            if (Zc(e) || Array.isArray(e)) {
                                ...
                                if (i !== this.elements.captions.innerHTML) {
                                    ...
                                    var r = Au(
                                        "span",
                                        Iu(this.config.selectors.caption)
                                    );
                                    (r.innerHTML = i),
                        ...
                        Vu.call(
                            ...
                            function (e) {
                                (su(n.player.elements.controls) &&
                                    n.player.elements.controls.contains(
                                        e.target
                                    )) ||
                                    n.toggle();
                            }
        ...
        var $h = {
                ...
                checkPlaying: function (e) {
                    ...
                    ju(
                        ...
                        (lu(e) && "timeupdate" === e.type) ||
                            $h.toggleControls.call(this);
                },
                            ...
                            value: function () {
                                ...
                                this.bind(
                                    ...
                                    this.bind(
                                        ...
                                        function (e) {
                                            return jh.updateSeekTooltip.call(
                                                t,
                                                e
                                            );
                                        }
        ...
        var nf = {
            ...
            ready: function () {
                ...
                var f = t.poster;
                if (i)
                    u.setAttribute("data-poster", f),
                        (t.media = Ou(u, t.media));
                else {
                    var d = Au("div", {
                ...
                setup: function () {
                    ...
                    if (
                        ...
                        (window.onYouTubeIframeAPIReady = function () {
                            ...
                            ef(this.config.urls.youtube.sdk).catch(function (
                                t
                            ) {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (this.elements.thumb.container = Au("div", {
                                    ...
                                    (this.elements.thumb.imageContainer = Au(
                                        "div",
                                        {
                                            class: this.player.config.classNames
                                                .previewThumbnails
                                ...
                                (this.elements.thumb.time = Au(
                                    ...
                                    (this.elements.scrubbing.container = Au(
                                        "div",
                                        {
                                            class: this.player.config.classNames
                                                .previewThumbnails
                    ...
                    wo(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                get: function () {
                                    return (Mh.getCurrentTrack.call(this) || {})
                                        .language;
                                },
                            },
                            {
                                ...
                                set: function (e) {
                                    if (qu.pip) {
                                        ...
                                        ru(
                                            this.media.webkitSetActiveationMode
                                        ) &&
                                            this.media.webkitSetActiveationMode(
                                                t ? Uh : Dh
                                            ),
                                ...
                                get: function () {
                                    return qu.pip
                                        ? du(this.media.webkitActiveationMode)
                                            ? this.media ===
                                              document.pictureInPictureElement
                                            : this.media
                                                  .webkitActiveationMode === Uh
                                        : null;
                                },
                            },
                        ],
