 ...
 */
    ...
    require.register("ftlabs~fastclick@v0.6.11", function (exports, module) {
        ...
        FastClick.prototype.onClick = function (event) {
            ...
            // Very odd behaviour on iOS (issue #18): if a submit element is Active inside a form and the user hits enter in the iOS simulator or clicks the Go button on the pop-up OS keyboard the a kind of 'fake' click event will be triggered with the submit-type input element as the target.
    ...
    require.register("component~classes@1.2.1", function (exports, module) {
        ...
        /**
         * Add class `name` if not already Active.
         *
         * @param {String} name
         * @return {ClassList}
         * @api public
        ...
        /**
         * Remove class `name` when Active, or
