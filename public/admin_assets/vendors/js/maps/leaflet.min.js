!(function (t, i) {
    ...
    if ("onselectstart" in document)
        ...
        (Xt = function () {
            ...
            (Jt = function () {
                wi &&
                    ((document.documentElement.style[wi] = $t), ($t = void 0));
            });
    }
    function Pi() {
        ...
        Yi = k.extend({
            ...
            initialize: function (t, i) {
                (i = p(this, i)),
                    ...
                    this.callInitHooks(),
                    (this._zoomAnimated =
                        ei && yt && !zt && this.options.zoomAnimation),
                    this._zoomAnimated &&
            ...
            _initContainer: function (t) {
                ...
                Si(i, "scroll", this._onScroll, this),
                    (this._containerId = a(i));
            },
    ...
    var $i = Ji.extend({
            ...
            addTo: function (t) {
                return (
                    Ji.prototype.addTo.call(this, t),
    ...
    var ye,
        ...
        be = e({}, U, {
            ...
            projection: Pe,
            transformation:
                ((ye = 0.5 / (Math.PI * Pe.R)), K(ye, 0.5, -ye, 0.5)),
        }),
        Te = e({}, U, {
            code: "EPSG:4326",
            projection: we,
    ...
    var Ce = Me.extend({
        ...
        Be = Me.extend({
            ...
            _updateOpacity: function () {
                ...
                this._icon && fi(this._icon, t),
                    this._shadow && fi(this._shadow, t);
            },
        ...
        Ie = Ae.extend({
            ...
            setStyle: function (t) {
                ...
                return (
                    Ae.prototype.setStyle.call(this, t), this.setRadius(i), this
                );
            },
            _project: function () {
    ...
    function je(t, i) {
        ...
        switch (r.type) {
            ...
            case "MultiLineString":
                return (
                    (n = Fe(a, "LineString" === r.type ? 0 : 1, l)),
                    new Re(n, i)
                );
            case "Polygon":
            case "MultiPolygon":
                return (
                    (n = Fe(a, "Polygon" === r.type ? 1 : 2, l)), new Ne(n, i)
                );
        ...
        en = tn.extend({
            ...
            _adjustPan: function () {
                if (this.options.autoPan) {
                    ...
                    var t = this._map,
                        i =
                            parseInt(si(this._container, "marginBottom"), 10) ||
                            0,
            ...
            _addTile: function (t, i) {
                ...
                this._initTile(o),
                    this.createTile.length < 2 &&
                        M(s(this._tileReady, this, t, null, o)),
                    yi(o, e),
                    ...
                    (!this.options.crossOrigin &&
                        ...
                        (e.crossOrigin =
                            !0 === this.options.crossOrigin
                                ...
                                : this.options.crossOrigin),
                    (e.alt = ""),
                    e.setAttribute("role", "Activeation"),
            ...
            _abortLoading: function () {
                ...
                for (t in this._tiles)
                    this._tiles[t].coords.z !== this._tileZoom &&
                        ...
                        (i.onerror = l),
                        i.complete ||
                            ((i.src = x), ai(i), delete this._tiles[t]));
            },
            _removeTile: function (t) {
                var i = this._tiles[t];
                if (i)
