...
(function (factory) {
    ...
    TimePicker.prototype.disabled = function (timeToVerify) {
        var clock = this,
            ...
            isDisabledMatch = clock.item.disable.filter(function (
                timeToDisable
            ) {
                ...
                if ($.isArray(timeToDisable) || _.isDate(timeToDisable)) {
                    return (
                        timeToVerify.pick == clock.create(timeToDisable).pick
                    );
                }
    ...
    TimePicker.prototype.isTimeExact = function (one, two) {
        ...
        // When we’re working with time reActiveations, compare the “pick” value.
        if (
