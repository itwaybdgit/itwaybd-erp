                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="ending_date" id="ending_date" class="form-control"
                                        value="{{ $project->ending_date ?? '' }}" required>
                                    @error('ending_date')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2"
                                        ...
                                        <label for="hypercare" class="form-label">Hypercare <span
                                                class="text-danger">*</span></label>
                                        <select id="hypercare" class="form-select" name="hypercare">
                                            <option value="0" {{ old('hypercare', 1) == 0 ? 'selected' : '' }}>No
                                            </option>
                                            <option value="1" {{ old('hypercare', 1) == 1 ? 'selected' : '' }}>Yes
                                            </option>
                                        </select>
                                        @error('hypercare')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-6" id="hypercare_months_div" style="display: none;">
                                        <label for="hypercare_months" class="form-label">Hypercare Months <span
                                                class="text-danger">*</span></label>
                                        <input type="number" name="hypercare_months" id="hypercare_months"
                                            class="form-control" min="1"
                                            value="{{ old('hypercare_months', $project->hypercare_months) }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (hypercareSelect) {
                ...
                toggleHypercareMonths(); // পেজ লোডের সময় কল করুন
            }
        });
    </script>
@endsection
