            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <form class="text-rigth" method="post" style="border: 1px solid #000;padding:10px"
                            action="{{ route('imports.bandwidth_billings') }}" enctype="multipart/form-data">
                            @csrf
                            <input type="file" class="" name="file">
                            <button href="{{ $create_url ?? '#' }}" class="btn btn-rounded btn-info text-right">
