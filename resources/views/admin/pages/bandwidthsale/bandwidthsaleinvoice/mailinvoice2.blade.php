            ...
            <tr class="information">
                <td>
                    <table>
                        <tr>
                            <td style="width: 33%">
                                <img src="{{ public_path("storage/".$business->invoice_logo) }}" id="businessInvoiceLogo" width="200px"
                                    height="100px" alt="">
                            </td>
                            <td style="text-align:center;width: 33%">
                                <b style="font-size : 15px">{{ $saleinvoiceid->customer->company_name ?? 'N/A' }} </b> <br>
                                Invoice: {{ $saleinvoiceid->invoice_no ?? 'N/A' }} <br>

                                {{ $saleinvoiceid->customer->company_owner_phone ?? 'N/A' }} <br>
                            ...
                            <td style="text-align:right;width: 33%">
                                <b id="businessName" >{{ $business->business_name ?? '' }}</b>
                                <address>
                                    Phone : <strong
