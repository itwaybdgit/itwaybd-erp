            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="{{ route('bandwidthsaleinvoice.paystore') }}" method="POST"
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-6 mb-1">
                                    <label for="">Discount</label>
                                    <input type="number" class="form-control" value="{{ old('discount') }}" name="discount" step="0.01">
                                </div>
...
@push('scripts')
    <script>
        $(document).on('change', '#customer_id', function() {
            $.ajax({
                url: "{{ route('bandwidthsaleinvoice.getAvailableBalance') }}",
                type: 'GET',
                dataType: 'JSON',
                data: {
                ...
                success: function(data) {
                    $('.showAmount').text('Due Balance ' + data.amount.toFixed(2));
                    $('.payAmount').attr('max', data.amount.toFixed(2))
                }
            })
        })
    </script>
