...
<style>
    ...
    .footer .our-products span{
        font-weight: 600;
        font-size: 18px;
        white-space: nowrap;
    }

    .footer .our-products img {
        max-height: 50px;
        width: auto;
    }
            ...
            <div class="card card-default">
                ...
                @foreach ($detals as $lo => $itellist)
                    ...
                    <div class="invoice printDiv p-3 mb-3" id="DivIdToPrint{{$lo}}">
                        <!-- title row -->
                        <!-- info row -->
                        <div class="row invoice-info" style="background-color: #ffffff!important;">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="our-products">
                                            ...
                                            <img src="{{ asset('image/op.png') }}" alt="Our Products">
                                        </div>
                                    </div>
