                          ...
                          <div class="card-body">
                            <table class="table table-borderless table-striped">
                                ...
                                <tbody style="font-size: 0.8rem;">
                                  ...
                                  <tr>
                                    <td class="px-1" >
                                      <strong>{{ __('Generate Bill') }}</strong>
                                      <span style="padding: 0 0.25rem;">:</span>
                                      <span>{{ $customer->level_confirm == 2 ? 'Approved' : 'Pending' }}</span>
                                    </td>
                                    <td class="px-1" >
                                      <strong>{{ __('Approved By') }}</strong>
                                      <span style="padding: 0 0.25rem;">:</span>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="table-responsive" class="text-white">
                                                                        ...
                                                                        <div class="container">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    ...
                                                                                    {{ $customer->district->district_name ?? 'N/A'}}
                                                                                    @php
                                                                                @endphp
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <strong>Upazila </strong>:
                                                                                    {{ $customer->upazilla->upozilla_name ?? 'N/A' }}
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-md-12 mt-5">
                                                                            <div class="">
                                                                                <div class="">
                                                                                  <h3 class=" mb-5 text-center fw-100 " >{{ __('Legal Documents') }}</h3>
                                                                                </div>
                                                                                <div class="">
                                                                                  <div class="row bg-white">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                      <div class="card">
                                                                                        <div class="card-header p-0">
                                                                                          <h6 class=" py-0 my-0">{{ __('NOC Payment Clearance') }}</h6>
                                                                                        </div>
                                                                                        <div class="card-body p-0">
                                                                                          @php
