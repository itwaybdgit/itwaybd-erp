            ...
            <div class="main-body">
                  <div class="row gutters-sm">
                    ...
                    <div class="col-md-12 mb-1">
                        <form action="{{route('discontinue_confrim_billing.confirm', $discontinue->id)}}" method="post">
                            @csrf
                        <div class="card">
                            <div class="card-body">
                                <h5>Package</h5>
                                ...
                                <div class="row mt-3 mb-3">
                                    <div class="col-6">
                                           ...
                                           <input type="hidden" name="reseller_upgradation" value="{{$discontinue->id}}">
                                           <input type="date"  name="apply_date" class="form-control" value="{{$discontinue->apply_date}}" id="apply_date">
                                    </div>
                                 </div>
                            </div>
                        </div>
