                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <div class="container">
                                    <button type="button" class="btn btn-primary  confirm" approve-route="{{ route('optimize_tx.approve', $optimize->id) }}">{{ __('Confirm') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($package->item_id as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $package->total_quantity[$key] }}
                                                </td>
                                                @php
                                                    $oldtotal += $package->old_quantity[$key];
                                                    $total += $package->total_quantity[$key];
                                                @endphp
                                            </tr>
                                        @endforeach
                                    </tbody>
