            ...
            <div class="main-body">
                  <div class="row gutters-sm">
                    ...
                    <div class="col-md-12 mb-1">
                        <form action="{{route('upgradtion-confrim-billing.confirm', $customer->id)}}" method="post">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">
                                                <small class="text-secondary">Upgradation Quantity</small>
                                            </th>
                                            <th scope="col">
                                ...
                                <div class="row mt-3 mb-3">
                                    <div class="col-6">
                                           ...
                                           <input type="hidden" name="reseller_upgradation" value="{{$resellerUpgradation->id}}">
                                           <input type="date"  name="apply_date" class="form-control" value="{{$resellerUpgradation->apply_date}}" id="apply_date">
                                    </div>
                                 </div>
                            </div>
                        </div>
