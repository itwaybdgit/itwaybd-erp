                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <select name="status" class="form-control" id="">
                                    <option {{$editinfo->status == "Active" ? "selected":""}} value="Active">Active</option>
                                    <option {{$editinfo->status == "Resigned" ? "selected":""}} value="Resigned">Resigned</option>
                                    <option {{$editinfo->status == "Suspended" ? "selected":""}} value="Suspended">Suspended</option>
                                </select>
                                @error('status')
                                    <span class=" error text-red text-bold">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <select name="type[]" class="form-control js-example-tokenizer" multiple="multiple">
                                    <option {{in_array('team_leader',$typevalue) ? "selected":"" }} value="team_leader">Team Leader</option>
                                    <option {{in_array('Sales',$typevalue) ? "selected":"" }} value="Sales">Sales</option>
                                    <option {{in_array('legal_department',$typevalue) ? "selected":"" }} value="legal_department">Legal department</option>
                                    <option {{in_array('billing_department',$typevalue) ? "selected":"" }} value="billing_department">Bliing Department</option>
                                    <option {{in_array('tx_planning',$typevalue) ? "selected":"" }} value="tx_planning">Tx Planning</option>
                                    <option {{in_array('transmission',$typevalue) ? "selected":"" }} value="transmission">Transmission</option>
                                    <option {{in_array('level_1',$typevalue) ? "selected":"" }} value="level_1">Level 1</option>
                                    <option {{in_array('level_2',$typevalue) ? "selected":"" }} value="level_2">Level 2</option>
                                    <option {{in_array('level_3',$typevalue) ? "selected":"" }} value="level_3">Level 3</option>
                                    <option {{in_array('level_4',$typevalue) ? "selected":"" }} value="level_4">Level 4</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-1">
                                ...
                                <select name="achieved_degree" class="form-control select2">
                                    <option {{$editinfo->achieved_degree == "Uneducated" ? "selected":"" }} value="Uneducated">Uneducated</option>
                                    ...
                                    <option {{$editinfo->achieved_degree == "Diploma" ? "selected":"" }} value="Diploma">Diploma</option>
                                    <option {{$editinfo->achieved_degree == "Honours/Equivalent" ? "selected":"" }} value="Honours/Equivalent">Honours/Equivalent</option>
                                    <option {{$editinfo->achieved_degree == "Masters/Equivalent" ? "selected":"" }} value="Masters/Equivalent">Masters/Equivalent</option>
                                    <option {{$editinfo->achieved_degree == "Mphil/Phd" ? "selected":"" }} value="Mphil/Phd">Mphil/Phd</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-1">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <textarea value="{{ $editinfo->professional_experiences }}" name="professional_experiences" class="form-control input-rounded"></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-1">
                                <label for="bank_account_information">Bank Account Information</label>
                                 <input type="text" value="{{$editinfo->bank_account_information}}" name="bank_account_information" class="form-control">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <select name="team" class="form-control">
                                    ...
                                    @foreach ($teams as $value)
                                        <option {{$editinfo->team == $value->id ? "selected":""}} value="{{ $value->id }}">{{ $value->name }}</option>
                                    @endforeach
                                </select>
                                @error('team')
                                    <span class=" error text-red text-bold">{{ $message }}</span>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 mb-1">
                                ...
                                <input type="text" class="form-control input-rounded"
                                    value="{{ old('username') ?? ($editinfo->employelist->username ?? '') }}"
                                    name="username">
                            </div>
                            <div class="col-md-3 mb-1">
                            ...
                            <div class="col-md-3 mb-1">
                                ...
                                <input type="password" class="form-control input-rounded"
                                    value="{{ old('password') ?? $editinfo->password }}" autocomplete="new-password"  name="password">
                            </div>
