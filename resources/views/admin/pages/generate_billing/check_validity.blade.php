            ...
            <div class="main-body">
                <div class="row gutters-sm">
                    ...
                    <div class="col-md-12 mb-1">
                        <form action="{{ route('generate_billing.confirm', $customer->id) }}" method="post">
                            @csrf
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th style="padding: 10 5 !important;" > Company</th>
                                        <th style="padding: 10 5 !important;" > Item</th>
                                        <th style="padding: 10 5 !important;" > Quantity</th>
                                        <th style="padding: 10 5 !important;" > Rate</th>
                                        <th style="padding: 10 5 !important;" > VAT(%)</th>
                                        <th style="padding: 10 5 !important;" > From Date</th>
                                        <th style="padding: 10 5 !important;" > To Date</th>
                                        <th style="padding: 10 5 !important;" > Total</th>
                                        <th style="padding: 10 5 !important;" style="    display: none;" > Action</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody class="package-table">
                                    @foreach ($customer->package as $value)
                                        <tr>
                                            ...
                                            <th>
                                                <button class="btn btn-danger btn-trash" type="button" > <i class="fas fa-trash"></i> </button>
                                              </th>
                                        </tr>
                                    @endforeach
                                </tbody>
...
@section('scripts')
    <script>
        ...
        function getDaysInCurrentMonth() {
                ...
                const month = now.getMonth(); // Note: 0 is January, 11 is December
        ...
        function getLong(formday, today) {
            ...
            if(diffDays >= 30){
                ...
                diffDays = getDaysInCurrentMonth();
            }
            return diffDays;
        }
