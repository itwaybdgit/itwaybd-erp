                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-1">
                                ...
                                <select name="roll_id" class="form-control">
                                    ...
                                    @foreach ($userrolls as $userroll)
                                        <option {{ $editinfo->employelist->roll_id == $userroll->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-3 mb-1">
                                ...
                                <select name="access_type" class="form-control">
                                    ...
                                    <option {{ $editinfo->employelist->is_admin == 5 ? 'selected' : '' }} value="5">
                                        Manager</option>
                                    <option {{ $editinfo->employelist->is_admin == 4 ? 'selected' : '' }} value="4">
                                        Employee</option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-1">
