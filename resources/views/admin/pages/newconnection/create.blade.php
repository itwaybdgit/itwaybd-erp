                        ...
                        <form action="{{ $store_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" class="form-control" name="registrationformno" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="file" class="form-control" name="nid_picture" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" class="form-control" name="roadnumber" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <textarea type="text" class="form-control" id="Activeaddress" name="Activeaddress" placeholder=""></textarea>
                                </div>
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <textarea type="text" class="form-control" name="permanentaddress" id="permanentaddress" placeholder=""></textarea>
                                </div>
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select class="form-control select2" id="single-select" name="connectiontype">
                                        ...
                                        @foreach ($connectiontypes as $connectiontype)
                                            <option value="{{ $connectiontype->id }}">{{ $connectiontype->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
