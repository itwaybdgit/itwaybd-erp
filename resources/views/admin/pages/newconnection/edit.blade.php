                        ...
                        <form action="{{ $update_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $editinfo->name }}"
                                        placeholder="Name">
                                </div>
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" class="form-control" name="occupation"
                                        value="{{ $editinfo->occupation }}" placeholder="">
                                </div>

                                <div class="col-md-6 mb-1">
                                    <label for="">Date of Birth</label>
                                    <input type="date" class="form-control" name="dateofbirth"
                                        value="{{ $editinfo->dateofbirth }}" placeholder="">
                                </div>

                                <div class="col-md-6 mb-1">
                                    <label for="">Father Name</label>
                                    <input type="text" class="form-control" name="father_name"
                                        value="{{ $editinfo->father_name }}" placeholder="Father name">
                                </div>

                                <div class="col-md-6 mb-1">
                                    <label for="">Mother Name</label>
                                    <input type="text" class="form-control" name="mother_name"
                                        value="{{ $editinfo->mother_name }}" placeholder="Mother name">
                                </div>

                                <div class="col-md-6 mb-1">
                                    <label for="">NID/Birth Certificate No</label>
                                    <input type="text" class="form-control" name="nid" value="{{ $editinfo->nid }}"
                                        placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                    <label for="">Registration Form No</label>
                                    <input type="text" class="form-control" name="registrationformno"
                                        value="{{ $editinfo->registrationformno }}" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                    <label for="">Remarks</label>
                                    <input type="text" class="form-control" name="remarks"
                                        value="{{ $editinfo->remarks }}" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                    <label for="">Profile Picture</label>
                                    <input type="file" class="form-control" name="profile_picture"
                                        value="{{ $editinfo->profile_picture }}" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                    <label for="">NID/Birth Certicate Picture</label>
                                    <input type="file" class="form-control" name="nid_picture"
                                        value="{{ $editinfo->nid_picture }}" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                    <label for="">Registration Form Picture</label>
                                    <input type="file" class="form-control" name="registrationformpicture"
                                        value="{{ $editinfo->registrationformpicture }}" placeholder="">
                                </div>
                            </div>
                            <hr>
                            <div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="number" class="form-control" name="mobilenumber"
                                        value="{{ $editinfo->mobilenumber }}" placeholder="">
                                </div>

                                <div class="col-md-6 mb-1">
                                    <label for="">Phone Number</label>
                                    <input type="number" class="form-control" name="phonenumber"
                                        value="{{ $editinfo->phonenumber }}" placeholder="">
                                </div>

                                <div class="col-md-6 mb-1">
                                    <label for="">Email Address</label>
                                    <input type="email" class="form-control" name="emailaddress"
                                        value="{{ $editinfo->emailaddress }}" placeholder="">
                                </div>

                                <div class="col-md-6 mb-1">
                                    <label for="">Facebook Profile Link</label>
                                    <input type="text" class="form-control" name="facebookprofilelink"
                                        value="{{ $editinfo->facebookprofilelink }}" placeholder="">
                                </div>

                                <div class="col-md-6 mb-1">
                                    <label for="">Linkedin Profile Link</label>
                                    <input type="text" class="form-control" name="linkedinprofilelink"
                                        value="{{ $editinfo->linkedinprofilelink }}" placeholder="Father name">
                                </div>
                                    ...
                                    <select class="form-control" id="single-select" name="district">
                                        ...
                                        @foreach ($districts as $district)
                                            <option value="{{ $district->id }}"
                                                {{ $editinfo->district == $district->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control" id="single-select" name="upazila">
                                        ...
                                        @foreach ($upazilas as $upazila)
                                            <option value="{{ $upazila->id }}"
                                                {{ $editinfo->upazila == $upazila->id ? 'selected' : '' }}>
                                                {{ $upazila->upozilla_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" class="form-control" name="roadnumber"
                                        value="{{ $editinfo->roadnumber }}" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                    <label for="">House Number</label>
                                    <input type="text" class="form-control" name="housenumber"
                                        value="{{ $editinfo->housenumber }}" placeholder="">
                                </div>
                                <div class="col-md-6 mb-1">
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <textarea type="text" class="form-control" id="Activeaddress" name="Activeaddress" placeholder="">{!! $editinfo->Activeaddress !!}</textarea>
                                </div>
                                <div class="col-md-4 mb-1 text-center">
                                    <h3 for="">Same as Active address?</h3>
                                    <div class="">
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <textarea type="text" class="form-control" name="permanentaddress" id="permanentaddress" placeholder="">{!! $editinfo->permanentaddress !!}</textarea>
                                </div>
                                    ...
                                    <select class="form-control select2" id="single-select" name="zone">
                                        ...
                                        @foreach ($zones as $zone)
                                            <option value="{{ $zone->id }}"
                                                {{ $editinfo->zone == $zone->id ? 'selected' : '' }}>{{ $zone->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select class="form-control select2" id="single-select" name="subzone">
                                        ...
                                        @foreach ($subzones as $subzone)
                                            <option value="{{ $subzone->id }}"
                                                {{ $editinfo->subzone == $subzone->id ? 'selected' : '' }}>
                                                {{ $subzone->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select class="form-control select2" id="single-select" name="connectiontype">
                                        ...
                                        @foreach ($connectiontypes as $connectiontype)
                                            <option
                                                value="{{ $connectiontype->id }}"{{ $editinfo->connectiontype == $connectiontype->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control select2" id="single-select" name="clienttype">
                                        ...
                                        @foreach ($clienttypes as $clienttype)
                                            <option value="{{ $clienttype->id }}"
                                                {{ $editinfo->clienttype == $clienttype->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select class="form-control select2" id="single-select"
                                        onchange="profileId(this.value)" name="package_id">
                                        <option disabled selected>Select package</option>
                                        @foreach ($packages as $package)
                                            <option
                                                value="{{ $package->id }}"{{ $editinfo->package_id == $package->id ? 'selected' : '' }}>
                                                {{ $package->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select class="form-control select2" id="single-select" name="billingstatus">
                                        ...
                                        @foreach ($billingstatuses as $billingstatus)
                                            <option value="{{ $billingstatus->id }}"
                                                {{ $editinfo->billingstatus == $billingstatus->id ? 'selected' : '' }}>
                                                {{ $billingstatus->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-1">
...
@section('scripts')
    <script>
        $("#sameas").on('click', function() {
            ...
            if (same) {
                permanentaddress.val(Activeaddress.val());
            } else {
