                            ...
                            <div class="card-body">
                                ...
                                <span></span> --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-8 px-1">{{ $customer->license_type ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="container">
                                        ...
                                        <div class="col md-6">
                                         <h4>Reject From {{$revert->revertperson->name ?? ""}}</h4>
                                         <p>{{$revert->reason}}</p>
                                        </div>
                                        <div class="col-md-6 mt-2">
                                            <a href="{{ route('reverts.reject', $revert->id) }}" class="btn btn-danger ">{{ __('Reject') }}</a>

                                            <a type="button" class="btn btn-primary"
                                            href="{{ route('reverts.confirm', $revert->id) }}">{{ __('done') }}</a>
                                        </div>
