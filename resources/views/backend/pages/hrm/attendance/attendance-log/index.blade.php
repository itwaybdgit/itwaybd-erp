                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" colspan="2" style="width: 100px;">Date</th>
                            ...
                            <tbody>
                                @foreach ($attendances as $key => $attendance)
                                    @php
                                        ...
                                        if ($signOutRaw) {
                                            $signOutTime = Carbon\Carbon::parse($signOutRaw);
                                            if ($signOutTime->format('H') >= 0 && $signOutTime->format('H') < 6) {
                                                $actualOut = Carbon\Carbon::parse($attendance->date)
                                                    ->addDay()
                                                    ->setTimeFrom($signOutTime);
                                            } else {
                                                $actualOut = Carbon\Carbon::parse(
                                                    $attendance->date . ' ' . $signOutRaw,
                                                );
                                            }
                                ...
                                @endphp
                                <tr>
                                    <td colspan="7" class="text-right font-weight-bold">Total Overtime:</td>
                                    <td colspan="3">
                                        {{ $totalHours }} : {{ str_pad($totalMinutes, 2, '0', STR_PAD_LEFT) }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
