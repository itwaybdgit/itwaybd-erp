            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form class="needs-validation" method="POST"
                        action="{{ route('hrm.attendance.update.attendnace', $model->id) }}">
                        @csrf
                        <div class="card">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-1">
                                        ...
                                        <input type="date" class="form-control input-rounded" value="{{ $model->date }}"
                                            name="date">
                                        @error('date')
                                            <span class=" error text-red text-bold">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-1">
                                        ...
                                        <input type="time" name="sign_in" class="form-control" placeholder="Sign_in"
                                            value="{{ $model->sign_in }}">
                                        @error('sign_in')
                                            <span class=" error text-red text-bold">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-1">
                                        ...
                                        <input type="time" name="sign_out" class="form-control" placeholder="Sign_out"
                                            value="{{ $model->sign_out }}">
                                        @error('sign_out')
                                            <span class=" error text-red text-bold">{{ $message }}</span>
                                        @enderror
                                    </div>
