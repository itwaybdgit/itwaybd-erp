                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card-front-side">
                            ...
                            <table class="">
                                ...
                                <tr>
                                    <th width="30%">যোগদানের তাং</th>
                                    <td width="2%">:</td>
                                    <td>{{ $employee->join_date }}</td>
                                </tr>
                                <tr>
                                    <th width="30%">চাকুরীর ধরণ </th>
                                    <td width="2%">:</td>
                            ...
                            <div class="signature-area d-flex justify-content-between">
                                @if (isset($company->autority_signature))
                                    <img class="emp"
                                        src="{{ asset('/backend/autority_signature/' . $company->autority_signature) }}"
                                        height="20px" width="80px">
                                @endif
                                <p>কার্ডধারীর স্বাক্ষর</p>
                                <img class="author" src="{{ asset('/backend/autority_signature/autho.png') }}"
                                    width="80">
                                <p>অনুমোদনকারীর স্বাক্ষর</p>
                                {{-- <Br>
                                <Br>
                    ...
                    <div class="col-lg-6" id="idcardBackPrinting">
                        ...
                        <div class="card-back-side">
                            ...
                            <table class="table table-bordered table-resposive">
                                <tr>
                                    <th width="37%" style="height: 10px">রক্তের গ্রুপ</th>
                            ...
                            <div class="id-card-bottom text-center">
                                <p>আইডি কার্ডটি পাওয়া গেলে নিম্নোক্ত বা নিকটস্থ থানায় জমা দেওয়ার জন্য অনুরোধ করা যাচ্ছে ।
                                </p>
                                @if (isset($company->logo))
                                    <img src="{{ asset('/backend/logo/' . $company->logo) }}">
                                @endif
                                <p><b><u>ফ্যাক্টরী অফিস</b></u></p>
                                <p><b>প্লট ২৩/৩, মোল্লা রোড , আমতলা, কাঠগড়া, আশুলিয়া, সাভার, ঢাকা</b></p>
                            </div>
