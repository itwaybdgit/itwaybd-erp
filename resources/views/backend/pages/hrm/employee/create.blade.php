...
@section('content')
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            ...
            <form action="{{ route('hrm.employee.store') }}" method="POST" enctype="multipart/form-data" autocomplete="false">
                @csrf
                <x-alert></x-alert>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <select name="zone_id[]" id="" class="form-control select2" multiple>
