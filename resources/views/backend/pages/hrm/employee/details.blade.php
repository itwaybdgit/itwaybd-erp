                            ...
                            <div class="card-body pt-0">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td width="2%">:</td>
                                        <td> <img style="width:350px"
                                                src="{{ asset('/storage/photo/' . $employee->guardian_nid) }}"> </td>
                                    </tr>
                        ...
                        <div class="card-front-side">
                            ...
                            <div class="signature-area d-flex justify-content-between">
                                @if (isset($employee->emp_signature))
                                    <img class="emp" src="{{ asset('/storage/photo/' . $employee->emp_signature) }}"
                    ...
                    <div class="col-lg-6" id="idcardBackPrinting">
                        ...
                        <div class="card-back-side">
                            ...
                            <div class="id-card-bottom text-center">
                                <p>If the ID card is available, it is requested to submit it to the following or the nearest
                                    police station.
                                </p>
