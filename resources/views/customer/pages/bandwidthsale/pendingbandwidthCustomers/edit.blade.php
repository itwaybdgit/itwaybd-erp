                        ...
                        <form action="{{ $update_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <input type="text" value="{{$editinfo->company_owner_name}}" name="company_owner_name" class="form-control" required >
                                </div>

                                <div class="col-md-4 mb-1">
                                    <label>Company Owner Phone <span class="text-danger">*</span></label>
                                    <input type="tel" value="{{$editinfo->company_owner_phone}}" name="company_owner_phone" class="form-control" required >
                                </div>
                                ...
                                <div class="col-md-12 mb-1">
                                    ...
                                    <div class="col-md-4 mb-1">
                                        ...
                                        <input type="tel" value="{{$editinfo->customer_address}}" name="customer_address" class="form-control" >
                                    </div>
                                    ...
                                    <table id="table3" class="w-100">
                                                ...
                                                <th>
                                                    <select name="item_id[]" class="form-control item_id">
                                                        ...
                                                        @foreach ($items as $item)
                                                            <option {{$val->item_id == $item->id ? "selected":""}} value="{{ $item->id }}">{{ $item->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </th>
                                                <th>
                                                    <input type="number" value="{{$val->qty}}" name="quantity[]"
                                                        class="form-control qty calculation">
                                                </th>
                                                <th>
                                                    <input type="text" value="{{$val->rate}}" name="asking_price[]"
                                                        class="form-control rate calculation">
                                                </th>
                                                <th class="vatcolumn">
                                                    <input type="text"  value="{{$val->vat}}" name="vat[]"
                                        ...
                                        <tfoot>
                                            ...
                                            <tr style="background-color: #686868;">
                                                <td colspan="4" style="padding: 15px;"><span class="text-white">Total</span></td>
                                ...
                                @endif
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" value="{{$editinfo->admin_name}}" name="admin_name" id="admin_name">
                                        </div>
                                        <div class="form-group">
                                          <label for="admin_designation">Designation</label>
                                          <input type="text" class="form-control" value="{{$editinfo->admin_designation}}" name="admin_designation" id="admin_designation">
                                        </div>
                                        <div class="form-group">
                                          <label for="admin_cell">Cell</label>
                                          <input type="text" class="form-control" value="{{$editinfo->admin_cell}}" name="admin_cell" id="admin_cell">
                                        </div>
                                        <div class="form-group">
                                          <label for="admin_email">Email</label>
                                          <input type="text" class="form-control" value="{{$editinfo->admin_email}}" name="admin_email" id="admin_email">
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" value="{{$editinfo->billing_name}}" name="billing_name" id="billing_name">
                                        </div>
                                        <div class="form-group">
                                          <label for="billing_designation">Designation</label>
                                          <input type="text" class="form-control" value="{{$editinfo->billing_designation}}" name="billing_designation" id="billing_designation">
                                        </div>
                                        <div class="form-group">
                                          <label for="billing_cell">Cell</label>
                                          <input type="text" class="form-control" value="{{$editinfo->billing_cell}}" name="billing_cell" id="billing_cell">
                                        </div>
                                        <div class="form-group">
                                          <label for="billing_email">Email</label>
                                          <input type="text" class="form-control" value="{{$editinfo->billing_email}}" name="billing_email" id="billing_email">
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" value="{{$editinfo->technical_name}}" name="technical_name" id="technical_name">
                                        </div>
                                        <div class="form-group">
                                          <label for="technical_designation">Designation</label>
                                          <input type="text" class="form-control" value="{{$editinfo->technical_designation}}" name="technical_designation" id="technical_designation">
                                        </div>
                                        <div class="form-group">
                                          <label for="technical_cell">Cell</label>
                                          <input type="text" class="form-control" value="{{$editinfo->technical_cell}}" name="technical_cell" id="technical_cell">
                                        </div>
                                        <div class="form-group">
                                          <label for="technical_email">Email</label>
                                          <input type="text" class="form-control" value="{{$editinfo->technical_email}}" name="technical_email" id="technical_email">
                                        </div>
                                    </div>
                                              ...
                                              <div class="row bg-white">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="card">
                                                    ...
                                                    <div class="card-footer p-0" style="margin-top: 5px;">
                                                        <input type="file" name="cheque_authorization" class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="card">
                                                    ...
                                                    <div class="card-footer p-0" style="margin-top: 5px;">
                                                        <input type="file" name="noc_payment_clearance" class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="card">
                                                    ...
                                                    <div class="card-footer p-0" style="margin-top: 5px;">
                                                        <input type="file" name="isp_license" class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="card">
                                                    ...
                                                    <div class="card-footer p-0" style="margin-top: 5px;">
                                                        <input type="file" name="partnership_deed_org" class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="card">
                                                    ...
                                                    <div class="card-footer p-0" style="margin-top: 5px;">
                                                        <input type="file" name="cert_of_incorporation" class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="card">
                                                    ...
                                                    <div class="card-footer p-0" style="margin-top: 5px;">
                                                        <input type="file" name="equipment_agreement" class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="card">
                                                    ...
                                                    <div class="card-footer p-0" style="margin-top: 5px;">
                                                        <input type="file" name="iP_lease_agreement" class="form-control">
                                                  ...
                                                  <div class="card">
                                                    ...
                                                    <div class="card-body p-0">
                                                      ...
                                                      @elseif (in_array($extension25, ['xls', 'xlsx', 'csv']))
                                                        <img src="{{ asset('image/xls.png') }}" class="w-100" alt="">
                                                      @elseif (in_array($extension25, ['jpg', 'jpeg', 'png', 'webp', 'svg', 'gif']))
                                                        <img src="{{ asset('storage' . $legalInfo->work_order) }}" class="w-100" height="150px" alt="">
                                                      @else
