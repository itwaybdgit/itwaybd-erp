                        ...
                        <table id="server_side_lode" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>
                                      <a href="{{route('bandwidthcustomer.upgradation.show', $item->id)}}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                      {{-- <a href="{{route('bandwidthcustomer.upgradation.edit', $item->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a> --}}
                                    </th>
                                </tr>
                                @endforeach
                            </tbody>
